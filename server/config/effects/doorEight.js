...
module.exports = class DoorEight extends CombatEffect {
  association = EffectAssociation.BENEFICIAL;
  removeType = EffectRemoveType.DO_NOT_REMOVE;

  constructor(target, duration) {
    super(target, Effect.DOOR_EIGHT);

    this.duration = 9999999;
  }

  add(action) {
    this.fight.changeAtkTime(this.target, this.target.stats.attackTime.multipler + 80, this.target.stats.attackTime.additional);
